...
describe('authorized user', function () {
    ...
    test('can deactivate an active character', function () {
        ...
        livewire(CharactersList::class)
            ...
            ->callAction(TestAction::make('deactivateCharacter')->table($character))
            ->assertNotified();
    ...
    test('can deactivate multiple active characters', function () {
        ...
        livewire(CharactersList::class)
            ...
            ->callAction(TestAction::make('bulkDeactivateCharacter')->table()->bulk())
            ->assertNotified();
    ...
    test('has the correct permissions for list characters page', function () {
        ...
        livewire(CharactersList::class)
            ...
            ->assertActionVisible(TestAction::make('deactivateCharacter')->table($activeCharacter))
...
describe('unauthorized user', function () {
    ...
    test('cannot deactivate multiple active characters', function () {
        ...
        livewire(CharactersList::class)
            ...
            ->selectTableRecords($characters)
            ->assertActionHidden(TestAction::make('bulkDeactivateCharacter')->table()->bulk());
