        ...
        <div class="relative isolate overflow-hidden bg-white">
            ...
            <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                    ...
                    <h1 class="mt-24 sm:mt-32 lg:mt-16 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Document root not properly configured</h1>

                    <p class="mt-6 text-lg leading-8 text-gray-600">It appears that your server is not configured to use the <em>public</em> folder as your document root. Please refer to the Nova 3 installation guide for information about your document root and configuring your server to use the correct path. Once that’s complete, you can click Try Again.</p>
                    ...
                    <div class="mt-10 flex items-center gap-x-6">
                        ...
                        <a href="https://anodyne-productions.com/docs/3.0/installation" target="_blank" class="text-sm font-semibold leading-6 text-gray-900">
