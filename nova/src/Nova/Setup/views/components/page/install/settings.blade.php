...
{{ Form::open() }}
	<fieldset>
		...
		<div class="control-group<?php if ($errors->has('sim_name')){ echo ' has-error';}?>">
			...
			<div class="controls">
				{{ Form::text('sim_name', Input::old('sim_name'), array('class' => 'col col-lg-5 input-with-feedback')) }}
		...
		<div class="row">
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('name')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::text('name', Input::old('name'), array('class' => 'col col-lg-10 input-with-feedback')) }}
			...
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('email')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::email('email', Input::old('email'), array('class' => 'col col-lg-10 input-with-feedback')) }}
		...
		<div class="row">
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('password')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::password('password', array('class' => 'col col-lg-10 input-with-feedback', 'id' => 'password')) }}
			...
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('password_confirm')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::password('password_confirm', array('class' => 'col col-lg-10 input-with-feedback')) }}
		...
		<div class="row">
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('first_name')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::text('first_name', Input::old('first_name'), array('class' => 'col col-lg-10 input-with-feedback')) }}
			...
			<div class="col col-lg-6">
				<div class="control-group">
					...
					<div class="controls">
						{{ Form::text('last_name', false, array('class' => 'col col-lg-10')) }}
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('position')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::position('position', Input::old('position'), array('class' => 'col col-lg-10 input-with-feedback', 'id' => 'positionDrop'), 'open.playing', true) }}
		...
		<div class="row">
			<div class="col col-lg-6">
				<div class="control-group<?php if ($errors->has('rank')){ echo ' has-error';}?>">
					...
					<div class="controls">
						{{ Form::rank('rank', Input::old('rank'), array('class' => 'col col-lg-10 input-with-feedback', 'id' => 'rankDrop'), true) }}
