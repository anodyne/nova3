...
/**
 * @method static static from(string $title, string $icon, PostingTarget $target, bool $userSelectableTimeframe, LeaderboardTimeframe $timeframe, ?int $numberOfSpotsToShow, bool $showRankNumbers, bool $hideUsersWithZero, bool $onlyActiveUsers, bool $enabled, bool $showPodium)
 */
