					...
					<div class="col-12 col-sm-4 col-lg-3">
						<div class="hidden-sm">
							<div class="btn-toolbar pull-right">
								<div class="btn-group">
									<a href="#" class="btn btn-small btn-default tooltip-top js-task-action icn-size-16" title="{{ ucfirst(lang('short.view', langConcat('roles with this task'))) }}" data-action="view" data-id="{{ $t->id }}">{{ $_icons['view'] }}</a>
									
									@if (Sentry::getUser()->hasAccess('role.update'))
										<a href="{{ URL::to('admin/role/tasks/'.$t->id) }}" class="btn btn-small btn-default icn-size-16">{{ $_icons['edit'] }}</a>
									@endif
								</div>
