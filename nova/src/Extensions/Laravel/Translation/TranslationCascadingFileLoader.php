...
class TranslationCascadingFileLoader implements LoaderInterface {
	...
	public function __construct(Filesystem $files, $path)
	{
		...
		// Set the path to the app lang directory
		$this->path['app'] = APPPATH."lang";
		...
		if (is_array($modules))
		{
			...
			{
				if ($this->files->isDirectory(APPPATH."src/Modules/{$module}/lang"))
					$this->path[$module] = APPPATH."src/Modules/{$module}/lang";
			}
		}

		// Set the path to the core lang directory
		$this->path['app'] = NOVAPATH."lang";
	}
