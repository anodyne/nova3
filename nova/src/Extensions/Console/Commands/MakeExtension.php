<?php namespace Nova\Extensions\Console\Commands;
...
class MakeExtension extends Command
{
	...
	protected $description = 'Create a Nova 3 extension skeleton';
	...
	private function createFileFromStub($stub, $path, $fileName, array $replacements = [])
	{
		...
		$content = $this->files->get(app_path("Extensions/stubs/{$stub}.stub"));
