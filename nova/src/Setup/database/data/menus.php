...
return [
	...
	'menuItems' => [
		['menu_id' => 1, 'order' => 0, 'type' => "route", 'link' => "setup.home", 'title' => "Setup Center", 'icon' => 'magic'],
		...
		['menu_id' => 2, 'order' => 0, 'type' => "page", 'page_id' => 99, 'icon' => 'file-text'],

		['menu_id' => 2, 'order' => 1, 'type' => "internal", 'link' => "#", 'title' => "Manage", 'icon' => 'settings'],
