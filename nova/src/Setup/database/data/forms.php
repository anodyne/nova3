...
return [
	...
	'application' => [
		...
		'fields' => [
			...
			['form_id' => 1, 'order' => 1, 'type' => 'text', 'label' => "Experience", 'field_container_class' => 'col-md-3', 'help' => "How long have you been simming?", 'attributes' => '[{"name":"class","value":"form-control input-lg"},{"name":"placeholder","value":"Experience"}]', 'restrictions' => '[{"type":"view","value":""},{"type":"create","value":""},{"type":"edit","value":""}]'],
			['form_id' => 1, 'order' => 2, 'type' => 'textarea', 'label' => "Other Games", 'field_container_class' => 'col-md-8', 'help' => "What other game(s) do you actively participate on? Which characters do you play?", 'attributes' => '[{"name":"class","value":"form-control input-lg"},{"name":"placeholder","value":"Other Games"},{"name":"rows","value":"5"}]', 'restrictions' => '[{"type":"view","value":""},{"type":"create","value":""},{"type":"edit","value":""}]'],
		],
