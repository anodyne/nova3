...
return [
	...
	'character' => [
		...
		'fields' => [
			['form_id' => 2, 'tab_id' => 1, 'order' => 0, 'type' => 'dropdown', 'label' => "Gender", 'field_container_class' => 'col-md-3', 'attributes' => '[{"name":"class","value":"form-control input-lg"},{"name":"placeholder","value":"Choose One"}]', 'restrictions' => '[{"type":"view","value":""},{"type":"create","value":""},{"type":"edit","value":""}]', 'values' => '[{"text":"Male","value":"Male"},{"text":"Female","value":"Female"},{"text":"Hermaphrodite","value":"Hermaphrodite"},{"text":"Neuter","value":"Neuter"}]'],
