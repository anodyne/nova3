...
@section('content')
	...
	<div v-cloak>
		{!! Form::open(['route' => "setup.{$_setupType}.config.email.write", 'class' => 'form-horizontal']) !!}
			<div class="form-group row{{ ($errors->has('mail_driver')) ? ' has-error' : '' }}">
			...
			<div v-show="driver == 'smtp'">
				...
				<div class="form-group row{{ ($errors->has('mail_encryption')) ? ' has-error' : '' }}">
					<label class="col-md-3 col-form-label">Encryption</label>
					<div class="col-md-2">
			...
			<div v-show="driver == 'sendmail'">
				...
				<div class="form-group row{{ ($errors->has('mail_sendmail')) ? ' has-error' : '' }}">
					<label class="col-md-3 col-form-label">Sendmail Path</label>
					<div class="col-md-7">
						<div class="control-wrapper">
