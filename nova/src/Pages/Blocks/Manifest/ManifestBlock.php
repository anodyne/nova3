...
class ManifestBlock extends TiptapBlock
{
    public string $width = 'xl';

    public bool $slideOver = true;

    public ?string $icon = 'tabler-masks-theater';

    public ?string $label = 'Character manifest';

    public string $rendered = 'pages.pages.blocks.manifest.index';

    public string $preview = 'pages.pages.blocks.manifest.index-preview';
