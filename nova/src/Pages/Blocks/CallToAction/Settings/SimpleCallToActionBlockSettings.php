...
class SimpleCallToActionBlockSettings extends CallToActionBlockSettings
{
    public ?string $header = 'Simple CTA block';

    public ?string $identifier = 'cta-simple';

    protected bool $useHeaderOrientation = true;
