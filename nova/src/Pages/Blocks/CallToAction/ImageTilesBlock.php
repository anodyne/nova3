...
class ImageTilesBlock extends TiptapBlock
{
    public string $preview = 'pages.pages.blocks.call-to-action.image-tiles';

    public string $rendered = 'pages.pages.blocks.call-to-action.image-tiles';
