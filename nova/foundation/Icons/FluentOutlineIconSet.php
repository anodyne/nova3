...
class FluentOutlineIconSet extends IconSet
{
    public function icons(): array
    {
        return [
            ...
            'chevron-down' => 'fluent-o-chevron-down',
            'chevron-left' => 'fluent-o-chevron-left',
            'chevron-right' => 'fluent-o-chevron-right',
            'chevron-up' => 'fluent-o-chevron-up',
            ...
            'show' => 'fluent-o-eye',
            'sort-ascending' => 'fluent-o-arrow-sort-up',
            'sort-descending' => 'fluent-o-arrow-sort-down',
