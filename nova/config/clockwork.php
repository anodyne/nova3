...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork is enabled by default only when your application is in debug
    | mode. Here you can explicitly enable or disable Clockwork. When disabled,
    | no data is collected and the api and web ui are inactive.
    |
    */
    ...
    | have additional settings (eg. slow query threshold for database queries).
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork comes with a web UI accessibla via http://your.app/clockwork.
    ...
    */
    ...
    'requests' => [
        // With on-demand mode enabled, Clockwork will only profile requests
        // when the browser extension is open or you manually pass a
        // "clockwork-profile" cookie or get/post data key. Optionally you can
        // specify a "secret" that has to be passed as the value to enable
        // profiling.
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork can collect data about executed artisan commands. Here you can
    | enable and configure which commands should be collected.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork can collect data about executed queue jobs. Here you can enable
    | and configure which queue jobs should be collected.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork can collect data about executed tests. Here you can enable and
    | configure which tests should be collected.
    |
    */
    ...
    | disabled. Eg. for future analysis.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure how is the metadata collected by Clockwork stored. Two options
    | are available:
    ...
    */
    ...
    | authentication with a pre-configured password. You can also pass a class
    | name of a custom implementation.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork can collect stack traces for log messages and certain data like
    | database queries. Here you can set whether to collect stack traces, limit
    | the number of collected frames and set further configuration. Collecting
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork serializes the collected data to json for storage and transfer.
    | Here you can configure certain aspects of serialization. Serialization
    | has a large effect on the cpu time and memory usage.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Clockwork comes with a "clock" global helper function. You can use this
    | helper to quickly log something and to access the Clockwork instance.
    |
    */
    ...
    */
    ...
    | Chrome, your app, database and timeline event timings will be shown in
    | the Dev Tools network tab. This setting specifies the max number of
    | timeline events that will be sent. Setting to false will disable the
    | feature.
    |
    */
