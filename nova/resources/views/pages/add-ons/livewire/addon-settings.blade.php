<div x-data="{ open: false }" x-on:addon-settings-close="open = false" class="leading-none">
    @if ($iconTrigger)
                    ...
                    >
                        <x-spacing size="md">
                            <header class="flex items-center justify-between">
                                <x-h2>{{ $addon?->name }} add-on settings</x-h2>
                            </header>
                        </x-spacing>

                        <div class="relative mt-6 w-full flex-1 space-y-12 px-4 leading-normal sm:px-6">
                            @if ($addon->settings->hasSettings())
                                <x-fieldset>
                                    <x-fieldset.heading>
                                        <x-icon name="preferences"></x-icon>
                                        <x-fieldset.legend>Additional add-on settings</x-fieldset.legend>
                                        <x-fieldset.description>
                                            Customize various options for the add-on.
                                        </x-fieldset.description>
                                    </x-fieldset.heading>
