...
@section('content')
    <x-panel class="overflow-hidden" x-data="{ active: 'stories' }">
        <div class="grid grid-cols-2">
            <a
                href="{{ route('stories.timeline', 'stories') }}"
                @class([
                    'flex gap-3 px-8 py-4',
                    'rounded-br-md border-b border-r border-gray-200 bg-gray-100' => $type !== 'stories',
                ])
            >
                <div
                    @class([
            ...
            <a
                ...
                @class([
                    'flex gap-3 px-8 py-4',
                    'rounded-bl-md border-b border-l border-gray-200 bg-gray-100' => $type !== 'posts',
                ])
            >
                <div
                    @class([
