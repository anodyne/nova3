...
<div class="grid gap-8 | lg:grid-cols-4">
    <div class="order-2 | lg:col-span-3 lg:order-1">
        <p class="text-lg leading-8">{{ $story->description }}</p>

        <x-panel x-data="tabs()" class="mt-8">
            <div>
                        ...
                        <div class="flex items-center px-4 py-4 sm:px-6">
                            <div class="min-w-0 flex-1 flex items-center">
                                <div class="min-w-0 flex-1 md:grid md:grid-cols-2 md:gap-4">
                                    <div>
                                        <div class="leading-6 font-medium text-primary-600 truncate">Post title</div>
...
{{-- @if ($story->children->count() > 0)
    ...
    <div class="grid gap-6 max-w-lg mx-auto | lg:grid-cols-3 lg:max-w-none">
        ...
        <x-card x-data="{ id: {{ $subStory->id ?? 0 }} }">
            ...
            <p class="mt-1 flex items-center text-sm leading-6 text-gray-500">
