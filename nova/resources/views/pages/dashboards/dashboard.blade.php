            ...
            <div class="grid grid-cols-1 gap-8 lg:col-span-2">
                ...
                <section aria-labelledby="profile-overview-title">
                    <x-panel class="overflow-hidden">
                            ...
                            >
                                <div class="flex items-center space-x-5">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <p
                                            class="text-xl font-medium text-gray-900 dark:text-white sm:text-2xl"
                                        >
                                            {{ auth()->user()->name }}
                                        </p>
                                    </div>
                        ...
                        <div
                            class="grid grid-cols-1 divide-y divide-gray-900/5 border-t border-gray-900/5 bg-gray-50 dark:divide-gray-800 dark:border-gray-800 dark:bg-gray-950/30 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:rounded-b-md"
                        >
                            <a
                            ...
                            >
                                ...
                                ></x-icon>
                                <span
                                    class="group-hover:text-gray-900 dark:group-hover:text-gray-100"
                                >
                                    Characters
                                </span>
                            </a>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            >
                                                ...
                                                <div
                                                    class="min-w-0 flex-1 text-base md:text-sm"
                                                >
                                                    <div
