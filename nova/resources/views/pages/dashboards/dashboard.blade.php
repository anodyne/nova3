            ...
            <div class="grid grid-cols-1 gap-8 lg:col-span-2">
                ...
                <section aria-labelledby="profile-overview-title">
                    <x-panel class="overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 divide-y divide-gray-900/5 border-t border-gray-900/5 bg-gray-50 dark:divide-gray-800 dark:border-gray-800 dark:bg-gray-950/30 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:rounded-b-md">
                            <a href="{{ route('characters.index') }}" class="group flex items-center justify-center space-x-3 px-6 py-5 text-center text-base font-medium transition md:text-sm">
                                <x-icon name="characters" size="lg" class="text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-400"></x-icon>
                                <span class="group-hover:text-gray-900 dark:group-hover:text-gray-100">Characters</span>
                            </a>

                            <a href="#" class="group flex items-center justify-center space-x-3 px-6 py-5 text-center text-base font-medium transition md:text-sm">
                                <x-icon name="settings" size="lg" class="text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-400"></x-icon>
                                <span class="group-hover:text-gray-900 dark:group-hover:text-gray-100">Preferences</span>
                            </a>

                            <a href="#" class="group flex items-center justify-center space-x-3 px-6 py-5 text-center text-base font-medium transition md:text-sm">
                                <x-icon name="mail" size="lg" class="text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-400"></x-icon>
                                ...
                                <ul class="-mb-8">
                                    <li>
                                        <div class="relative pb-8">
                                            <span class="absolute left-5 top-4 -ml-px h-full w-0.5 bg-gray-400/20 dark:bg-gray-600/50" aria-hidden="true"></span>
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 text-base md:text-sm">
                                                    <div class="flex justify-between">
                                                        <p class="font-medium text-gray-700 dark:text-gray-300">Stanley Maura</p>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 text-base md:text-sm">
                                                    <div class="flex justify-between">
                                                        <p class="font-medium text-gray-700 dark:text-gray-300">Bethany Blake</p>
                                                        <time class="text-gray-500" datetime="2020-09-22">Sep 22</time>
                                                    </div>
                                                    <p class="text-gray-500">
                                                        Published
                                                        <x-button.text href="#" color="primary">Reckoning</x-button.text>
                                                        story post in
                                                        <x-button.text href="#" color="primary">Episode 2</x-button.text>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 text-base md:text-sm">
                                                    <div class="flex justify-between">
                                                        <p class="font-medium text-gray-700 dark:text-gray-300">Martha Gardner</p>
                                        ...
                                        <div class="relative pb-8">
                                            ...
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 text-base md:text-sm">
                                                    ...
                                                    <p class="text-gray-500">
                                                        Published
                                                        <x-button.text href="#" color="primary">Start of Day 3</x-button.text>
                                                        marker in
                                                        <x-button.text href="#" color="primary">Episode 2</x-button.text>
                                                    </p>
                                                </div>
