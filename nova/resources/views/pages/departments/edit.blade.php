                ...
                <div class="border-b border-gray-200 px-4 | sm:px-6">
                    <nav class="-mb-px flex">
                        <a
                            ...
                            class="whitespace-no-wrap ml-8 first:ml-0 py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 border-blue-500 text-blue-600 focus:outline-none"
                        >
                            Department Info
                        </a>
                        <a
                            href="{{ route('positions.index', $department) }}"
                            class="whitespace-no-wrap ml-8 first:ml-0 py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none"
                        >
                            Positions
                        </a>
                    </nav>
