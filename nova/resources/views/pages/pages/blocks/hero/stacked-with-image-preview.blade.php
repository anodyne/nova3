<div
    @class([
        'nv-hero nv-hero-stacked-with-image relative isolate overflow-hidden py-6 font-[family-name:--font-body] sm:py-8',
        ...
        <div class="nv-hero-ctn mx-auto max-w-2xl text-center">
            @if (filled($calloutText))
                ...
                >
                    <a
                        href="{{ $calloutUrl ?? '#' }}"
                        class="nv-hero-callout inline-flex space-x-6 !no-underline transition"
                    >
                        <span
                            @class([
