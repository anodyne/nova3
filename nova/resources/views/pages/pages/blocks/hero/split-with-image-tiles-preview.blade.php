<div
    @class([
        'nv-hero nv-hero-split-with-image-tiles relative isolate overflow-hidden py-6 sm:py-8',
        'nv-hero-split-with-image-tiles-light bg-[--bg-light]' => ! $dark,
        'nv-hero-split-with-image-tiles-dark bg-[--bg-dark]' => $dark,
    ])
>
    @if ($backgroundType !== 'color')
        <div class="nv-hero-overlay absolute inset-0">
            <img
                src="{{
            ...
            <div
                @class([
                    'nv-hero-overlay-color absolute inset-0',
                    'bg-black' => $dark,
                    'bg-white' => ! $dark,
                ...
                <div class="nv-hero-content-ctn lg:max-w-lg">
                    @if (filled($calloutText))
                        <div class="nv-hero-callout-ctn mt-24 sm:mt-32 lg:mt-16">
                            <a href="#" class="nv-hero-callout inline-flex space-x-6 !no-underline transition">
                                <span
                                    @class([
                    ...
                    @if (filled($heading))
                        <h1
                            @class([
                                'nv-hero-heading text-4xl font-bold tracking-tight sm:text-6xl',
                                'text-gray-900' => ! $dark,
                                'text-white' => $dark,
