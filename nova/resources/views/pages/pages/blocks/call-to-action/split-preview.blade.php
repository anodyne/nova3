<div
    @class([
        'nv-cta nv-cta-split not-prose relative isolate overflow-hidden font-[family-name:--font-body]',
        'nv-cta-split-light bg-[--bg-light]' => ! $dark,
        'nv-cta-split-dark bg-[--bg-dark]' => $dark,
    ])
...
>
    ...
    <div
        class="nv-cta-wrapper relative z-10 mx-auto max-w-7xl px-6 py-6 sm:py-8 lg:flex lg:items-center lg:justify-between lg:px-8"
    >
        @if (filled($heading))
            <h2
                @class([
                    'nv-cta-heading max-w-2xl font-[family-name:--font-header] text-3xl font-bold tracking-tight sm:text-4xl',
                    'text-gray-900' => ! $dark,
                    'text-white' => $dark,
                ])
            >
        ...
        @if (filled($primaryButtonUrl) || filled($secondaryButtonUrl))
            <div class="nv-cta-buttons-ctn mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
                ...
                @if (filled($secondaryButtonUrl) && filled($secondaryButtonLabel))
                    <a
                        ...
                        @class([
                            'nv-btn-secondary text-sm/6 font-semibold !no-underline',
