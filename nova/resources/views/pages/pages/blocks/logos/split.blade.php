...
>
    ...
    >
        <div class="nv-logos-wrapper @xs:px-6 @xl:px-8 mx-auto max-w-7xl">
            <div class="nv-logos-content-wrapper @xs:grid-cols-1 grid items-center gap-x-8 gap-y-16 @2xl:grid-cols-2">
                ...
                <div
                    class="nv-logos-image-ctn @xs:mx-auto @xs:max-w-xl @xs:gap-y-12 grid w-full grid-cols-2 items-center @2xl:mx-0 @2xl:max-w-none @2xl:gap-y-14 @2xl:pl-8"
                >
