...
>
            ...
            @else
                ...
                @if (isset($story) && $story->status->name() !== 'current')
                    <div class="mt-4 max-w-xl">
                        <x-panel.warning title="Non-current story selected" icon="warning" icon-size="xl">
        ...
        <x-fieldset.field-group>
            ...
            @else
                <x-panel variant="well">
                    <x-panel.header title="Choose your authors"></x-panel.header>
    ...
    <x-fieldset.controls>
        ...
        @else
            <x-panel.warning class="w-full" :description="$canGoToNextStepMessage"></x-panel.warning>
        @endif
    </x-fieldset.controls>
</x-write-post-wizard-layout>
