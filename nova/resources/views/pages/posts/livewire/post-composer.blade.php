                            ...
                            <flux:accordion.item expanded>
                                ...
                                <flux:accordion.content>
                                    <div class="space-y-4">
                                        <ul>
                                            @foreach ($post->characterAuthors as $characterAuthor)
                                                ...
                                                >
                                                    ...
                                                    <div class="text-xs/5">
                                                        played by {{ $characterAuthor->pivot?->user?->name }}
                                                    </div>
                                                </li>
                                            @endforeach
                                        ...
                                        <div class="px-3 py-1">
                                            <x-button
                                                wire:click="$dispatch('slide-over.open', {component: 'posts-manage-authors', arguments: {'post': {{ $post->id }}}})"
                                                color="primary"
                                                text
                                            >
                                                Manage authors &rarr;
                            ...
                            <flux:accordion.item expanded>
                                ...
                                <flux:accordion.content>
                                    <flux:modal.trigger name="edit-rating">
                                        ...
                                        >
                                            <x-rating.compact label="L" :value="$rating_language"></x-rating.compact>
                                            <x-rating.compact label="S" :value="$rating_sex"></x-rating.compact>
                                            <x-rating.compact label="V" :value="$rating_violence"></x-rating.compact>
                                        </button>
                                    </flux:modal.trigger>
                                </flux:accordion.content>
                            </flux:accordion.item>
                            ...
                            <flux:accordion.item expanded>
                                ...
                                <flux:accordion.content>
                                    <div class="space-y-4">
                                        ...
                                        <div class="px-2">
                                            <x-button color="primary" text>Update position &rarr;</x-button>
                                        </div>
                                    </div>
                                </flux:accordion.content>
                            </flux:accordion.item>
