    ...
    @if ($originalCount !== $count)
        <x-panel.warning>
            <x-slot name="description">
                ...
                {{ $count }} {{ trans_choice('character is|characters are', $count) }} eligible for activation. We
                will only activate the {{ $count }} {{ str('character')->plural($count) }} and ignore the others. If
                you would like to deactivate any active characters, you can use the Deactivate bulk action.
            </x-slot>
        </x-panel.warning>
    @endif
