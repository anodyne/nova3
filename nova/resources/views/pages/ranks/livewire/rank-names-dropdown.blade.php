            ...
            <div class="p-1.5" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                ...
                @forelse ($filteredNames as $name)
                    <button
                        ...
                        type="button"
                        class="group flex w-full items-center justify-between rounded-md px-4 py-2 text-base font-medium text-gray-500 transition hover:bg-gray-100 hover:text-gray-900 focus:outline-none md:text-sm dark:text-gray-400 dark:hover:bg-gray-600/50 dark:hover:text-gray-100"
                        role="menuitem"
                    >
                ...
                @empty
                    <div class="flex flex-col items-center pb-6 pt-2">
                        ...
                        <x-button wire:click="createAndSelectName" type="button" color="neutral">
                            Create this name
                        </x-button>
                    </div>
                @endforelse
