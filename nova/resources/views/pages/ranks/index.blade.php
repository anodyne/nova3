...
@section('content')
    ...
    <div class="mt-12 lg:grid lg:grid-cols-3 lg:gap-8">
        <x-card>
            ...
            <x-slot name="footer">
                <x-button-link :href="route('ranks.groups.index')" color="white" :full-width="true">
                    Go to rank groups
                </x-button-link>
            </x-slot>
        </x-card>
        ...
        <x-card>
            ...
            <x-slot name="footer">
                <x-button-link :href="route('ranks.names.index')" color="white" :full-width="true">
                    Go to rank names
                </x-button-link>
            </x-slot>
        </x-card>
        ...
        <x-card>
            ...
            <x-slot name="footer">
                <x-button-link :href="route('ranks.items.index')" color="white" :full-width="true">
                    Go to rank items
                </x-button-link>
            </x-slot>
        </x-card>
