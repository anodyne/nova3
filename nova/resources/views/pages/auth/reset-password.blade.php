    ...
    <x-form :action="route('password.update')">
        <x-fieldset>
            <x-fieldset.field-group>
                ...
                <x-fieldset.field label="Password" id="password" name="password" :error="$errors->first('password')">
                ...
                >
                    <x-input.password placeholder="Confirm your password" data-cy="password-confirm" required />
                </x-fieldset.field>
            </x-fieldset.field-group>
        </x-fieldset>
