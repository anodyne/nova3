<div x-data="{ open: false }" class="leading-none">
    <button
        ...
        type="button"
        class="relative p-1 text-gray-9 rounded-full transition ease-in-out duration-200 hover:text-gray-11 focus:outline-none focus:ring focus:text-gray-9"
    ...
    >
        <div x-show="open" class="absolute inset-0 overflow-hidden">
            <div
                ...
                class="absolute inset-0 bg-gray-12 opacity-75 transition-opacity"
                aria-hidden="true"
            ></div>
