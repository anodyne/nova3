...
>
    <div
        class="group relative flex w-full flex-col overflow-hidden rounded-md border border-gray-300 bg-white shadow-sm transition focus-within:border-primary-400 focus-within:ring-1 focus-within:ring-primary-400 dark:border-gray-700 dark:bg-gray-800 dark:focus-within:border-primary-700 dark:focus-within:ring-1 dark:focus-within:ring-primary-700"
    >
                ...
                <template x-if="editor">
                    ...
                    >
                        ...
                        <div class="my-1 flex items-center space-x-3 px-3 md:my-0 md:space-x-2">
                            ...
                            <button
                                type="button"
                                class="leading-0 text-gray-400 transition hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400"
                        ...
                        <div class="my-1 flex items-center space-x-3 px-3 md:my-0 md:space-x-2">
                            ...
                            <button
                                ...
                                x-on:click="setTextAlign('center')"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                        ...
                        <div class="my-1 flex items-center space-x-3 pl-3 md:my-0 md:space-x-2">
                            <button
                                type="button"
                                class="leading-0 text-gray-400 transition hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400"
                                x-on:click="$wire.set('codeView', true)"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
        ...
        <textarea
            name="{{ $fieldName }}"
            class="{{ $codeView ? '' : 'hidden' }} w-full appearance-none border-none bg-transparent px-3 py-4 font-mono leading-relaxed focus:outline-none focus:ring-0"
            rows="20"
