                    ...
                    <nav class="menu flex items-center flex-wrap divide-x divide-gray-100 dark:divide-gray-200/10 border-b border-gray-200 dark:border-gray-200/10 py-1.5 px-3 bg-gray-50 dark:bg-gray-900/50">
                        <div class="flex items-center space-x-3 md:space-x-2 my-1 md:my-0 pr-3">
                            <button
                                ...
                                :class="{ 'text-blue-500': isActive('bold', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('bold', updatedAt) }"
                                @click="toggleBold()"
                            >
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('italic', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('italic', updatedAt) }"
                                @click="toggleItalic()"
                            >
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('underline', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('underline', updatedAt) }"
                        ...
                        <div class="flex items-center space-x-3 md:space-x-2 my-1 md:my-0 px-3">
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('heading', { level: 1 }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('heading', { level: 1 }, updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('heading', { level: 2 }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('heading', { level: 2 }, updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('heading', { level: 3 }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('heading', { level: 3 }, updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('paragraph', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('paragraph', updatedAt) }"
                                @click="setParagraph()"
                            >
                        ...
                        <div class="flex items-center space-x-3 md:space-x-2 my-1 md:my-0 px-3">
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('bulletList', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('bulletList', updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('orderedList', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('orderedList', updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('link', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('link', updatedAt) }"
                                @click="setLink()"
                            >
                        ...
                        <div class="flex items-center space-x-3 md:space-x-2 my-1 md:my-0 px-3">
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive({ textAlign: 'left' }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive({ textAlign: 'left' }, updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive({ textAlign: 'center' }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive({ textAlign: 'center' }, updatedAt) }"
                            ...
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive({ textAlign: 'right' }, updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive({ textAlign: 'right' }, updatedAt) }"
                        ...
                        <div class="flex items-center space-x-3 md:space-x-2 my-1 md:my-0 px-3">
                            <button
                                type="button"
                                class="leading-0 transition"
                                :class="{ 'text-blue-500': isActive('blockquote', updatedAt), 'text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400': !isActive('blockquote', updatedAt) }"
