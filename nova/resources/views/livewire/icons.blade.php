<div x-data="{ open: false }" x-on:keydown.window.escape="open = false" x-on:click.away="open = false" x-on:icons-dropdown-close.window="open = false" class="relative inline-block w-full text-left leading-0">
            ...
            <div class="p-1.5" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                <div class="mb-2">
                    <div class="group mb-4 flex items-center space-x-3 rounded-md border-2 border-gray-100 bg-gray-100 px-2 py-2 text-gray-500 focus-within:border-gray-300 focus-within:bg-white focus-within:text-gray-700 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400 dark:focus-within:border-gray-500 dark:focus-within:bg-gray-700">
                        ...
                        <input wire:model.debounce.250ms="search" type="text" placeholder="Find an icon" class="flex w-full appearance-none border-none bg-transparent p-0 focus:outline-none focus:ring-0 dark:placeholder-gray-400" />
                ...
                @if (count($icons) > 0)
                    <div class="flex flex-wrap">
                        <div class="flex items-center justify-center">
                            <button type="button" wire:click="selectIcon('')" class="group flex w-full flex-col items-center rounded-md px-4 py-2 text-xs font-medium leading-tight text-gray-500 transition hover:bg-gray-100 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-600/50 dark:hover:text-gray-100">
                        ...
                        @foreach ($icons as $icon => $value)
                            <div class="flex items-center justify-center">
                                <button wire:click="selectIcon('{{ $icon }}')" type="button" class="group flex w-full items-center rounded-md px-4 py-2 text-base font-medium text-gray-500 transition hover:bg-gray-100 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-600/50 dark:hover:text-gray-100 md:text-sm" role="menuitem">
