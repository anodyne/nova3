<div>
    <x-content-box width="sm">
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100" id="modal-title">Add permissions</h3>
    </x-content-box>
                ...
                @if (count($selected) === 0 && $filteredPermissions->count() === 0)
                    <div class="flex flex-col items-center h-60">
                        <div class="flex flex-col flex-1 justify-center text-center">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No permissions selected</h3>
