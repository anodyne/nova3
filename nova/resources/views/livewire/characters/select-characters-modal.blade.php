<div>
    <x-content-box width="sm">
        <h3 class="text-lg leading-6 font-medium text-gray-12" id="modal-title">Add characters</h3>
    </x-content-box>
                ...
                @if (count($selected) === 0 && $filteredCharacters->count() === 0)
                    <div class="flex flex-col items-center h-60">
                        <div class="flex flex-col flex-1 justify-center text-center">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-12">No characters selected</h3>
