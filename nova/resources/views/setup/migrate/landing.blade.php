...
@section('title', 'Migrate from Nova 2')

@section('header', 'Migrate from Nova 2')
...
@section('controls')
	<a href="{{ route('setup.migrate.config.nova2') }}" class="btn btn-primary btn-lg">Next: Nova 2 Info</a>
	<a href="{{ route('setup.home') }}" class="btn btn-link btn-lg">Cancel</a>
@endsection