<ol class="relative mb-16 space-y-2" style="counter-reset: step 0">
    ...
    >
        <div class="mb-6 xl:mb-0">
            <h4 class="mb-2 text-sm leading-6 font-semibold text-gray-900">Verify the database connection values</h4>
            <div class="prose prose-sm prose-gray">
                <p>
                    Near the top of the
                    <code>.env</code>
                    file you’ll find the database connection values. Check to ensure they match what is shown to the
                    right.
                </p>
            </div>
        </div>
    ...
    >
        <div class="mb-6 xl:mb-0">
            <h4 class="mb-2 text-sm leading-6 font-semibold text-gray-900">Save and upload the .env file</h4>
            <div class="prose prose-sm prose-gray">
                <p>
                    If you need to update your database connection values, make sure you save the
                    <code>.env</code>
    ...
    >
        <div class="mb-6 xl:mb-0">
            <h4 class="mb-2 text-sm leading-6 font-semibold text-gray-900">Verify your database connection</h4>
            <div class="prose prose-sm prose-gray">
                <p>
                    Once you’ve verified your
                    <code>.env</code>
                    file and the database connection values, you can check again to see if Nova can connect to your
                    database
                </p>

                <x-setup::button type="button" wire:click="verifyDatabase" size="sm">
