<ol class="relative mb-16 space-y-2" style="counter-reset: step 0">
    ...
    >
        <div class="mb-6 xl:mb-0">
            <h4 class="mb-2 text-sm leading-6 font-semibold text-gray-900">Copy the code to the right</h4>
    ...
    >
        <div class="mb-6 xl:mb-0">
            <h4 class="mb-2 text-sm leading-6 font-semibold text-gray-900">Replace the database connection values</h4>
            <div class="prose prose-sm prose-gray">
                <p>
                    Near the top of the
                    <code>.env</code>
