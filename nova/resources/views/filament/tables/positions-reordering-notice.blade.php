...
<div>
  ...
  <x-content-box height="none" class="mb-6">
    <x-panel.primary icon="arrows-sort" title="Change sorting order">
      <div class="space-y-4">
        <p>We recommend filtering {{ $pluralModelLabel }} by their department before attempting to reorder them.</p>

        <p>{{ str($pluralModelLabel)->ucfirst() }} will appear in the order below whenever they're shown throughout Nova. To change the sorting of {{ $pluralModelLabel }}, drag them to the desired order. Click Finish to return to the management view.</p>
