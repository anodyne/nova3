...
@section('layout')
    <div x-data="{ open: false }" class="relative min-h-screen xl:flex xl:py-3">
        ...
        >
            ...
            <div class="fixed inset-0 flex">
                ...
                >
                    ...
                    <div
                        class="dark flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 ring-1 ring-white/10"
                    >
                            ...
                            >
                                ...
                                <li class="mt-auto">
                                    <ul role="list" class="space-y-2">
                                        ...
                                        <li class="p-2 leading-none">
                                            <div
                                                class="grid w-full grid-cols-2 rounded-md bg-gray-200 p-1"
                                            >
                                                <div
                                        ...
                                        --}}
                                        <li
                                            class="!mt-4 border-t border-gray-900/5 px-6 py-4 leading-none"
                                        >
        ...
        <main class="flex-1 py-10 focus:outline-none xl:ml-72" tabindex="0">
