...
@section('layout')
    <div class="flex relative min-h-screen py-6 px-6 gap-x-12">
        <nav x-data="{ open: false }" class="w-1/6">
            <div class="relative flex">
                <a href="{{ route('dashboard') }}" class="shrink-0 flex items-center">
                    ...
                    @else
                        <x-logos.nova class="hidden md:block h-10 w-auto" />
                        <x-logos.nova-mark class="block md:hidden h-8 w-auto" />
                    @endif
                </a>
            </div>

            <nav class="hidden lg:py-2 lg:flex lg:flex-col lg:space-y-1 mt-8" aria-label="Global">
            ...
            <div class="hidden max-w-7xl mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-100 dark:lg:divide-gray-700/50 lg:px-8">
        ...
        <main class="flex-1 py-8 lg:py-12 lg:px-8 focus:outline-none bg-gray-100 dark:bg-gray-800 rounded-xl" tabindex="0">
