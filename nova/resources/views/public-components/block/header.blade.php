...
@php
    ...
    $hasHeaderContent = filled(data_get($heading, 'text')) || filled(data_get($message, 'text')) || filled(data_get($callout, 'text'));
@endphp
...
@if ($hasHeaderContent)
    ...
    >
        ...
        >
            ...
            @if (filled(data_get($callout, 'text')))
                <div
                    @class([
                        'nv-callout-ctn',
