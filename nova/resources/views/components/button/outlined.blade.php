...
<{{ $tag }}
    {{
        $attributes->merge([
            ...
            'after:absolute after:inset-0 after:-z-10 after:rounded-[calc(theme(borderRadius.lg)-1px)] after:bg-white after:bg-opacity-50 after:shadow-[inset_0_1px_theme(colors.white/15%)] after:hover:bg-opacity-0 dark:after:-inset-px dark:after:rounded-lg dark:after:bg-gray-950 dark:after:bg-opacity-[65%] dark:after:shadow-[inset_0_1px_theme(colors.white/10%)] dark:after:hover:bg-opacity-50',
