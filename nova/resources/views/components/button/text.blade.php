...
<{{ $tag }}
    {{
        $attributes->merge([
            ...
            'relative isolate inline-flex items-center justify-center gap-1.5 text-center transition',
            match ($size) {
                ...
                'none-xs' => 'text-xs font-medium',
                'none' => 'text-sm font-semibold',
                'none-base' => 'text-base font-semibold',
            ...
            match ($color) {
                ...
                'dark-gray' => 'text-gray-600 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-200',
                'gray-primary' => 'text-gray-500 hover:text-primary-500 dark:text-gray-400 dark:hover:text-primary-500',
                'gray-danger' => 'text-gray-500 hover:text-danger-500 dark:text-gray-400 dark:hover:text-danger-500',
                'light-gray' => 'text-gray-400 hover:text-gray-500 dark:text-gray-600 dark:hover:text-gray-500',
                'light-gray-primary' => 'text-gray-400 hover:text-primary-500 dark:text-gray-600 dark:hover:text-primary-500',
                'light-gray-danger' => 'text-gray-400 hover:text-danger-500 dark:text-gray-600 dark:hover:text-danger-500',
