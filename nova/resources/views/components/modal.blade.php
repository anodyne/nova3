...
@push('modal')
    ...
    >
        ...
        <div
            ...
            class="relative bg-gray-1 rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all z-[999] sm:w-full sm:p-6 {{ $wide ? 'sm:max-w-lg' : 'sm:max-w-sm' }}"
            role="dialog"
            aria-modal="true"
