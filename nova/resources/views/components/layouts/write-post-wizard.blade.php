                            ...
                            <div class="flex items-start space-x-3">
                                @if ($step->isPrevious())
                                    <span class="shrink-0 relative h-5 w-5 flex items-center justify-center">
                                        ...
                                        <svg class="h-full w-full text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                ...
                                @if ($step->isCurrent())
                                    <span class="shrink-0 h-5 w-5 relative flex items-center justify-center" aria-hidden="true">
                                        <span class="absolute h-4 w-4 rounded-full bg-blue-200 dark:bg-blue-900"></span>
                                ...
                                <span @class([
                                    ...
                                    'text-blue-600 dark:text-blue-500' => $step->isCurrent(),
                    ...
                    <li class="md:flex-1">
                        <a
                            ...
                            @class([
                                ...
                                'border-blue-500 hover:border-blue-600 dark:hover:border-blue-400' => $step->isPrevious(),
                                'border-blue-500' => $step->isCurrent(),
                        ...
                        >
                            <span
                                @class([
                                    ...
                                    'text-blue-600 dark:text-blue-500 group-hover:text-blue-600 dark:group-hover:text-blue-500' => $step->isPrevious(),
                                    'text-blue-600 dark:text-blue-500' => $step->isCurrent(),
                    ...
                    <li @class([
                        ...
                        <a
                            ...
                            @class([
                                ...
                                'bg-blue-600 hover:bg-blue-900' => $step->isPrevious(),
                                'bg-white border-2 border-blue-600' => $step->isCurrent(),
