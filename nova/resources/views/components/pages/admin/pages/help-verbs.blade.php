...
<dl>
	<dt>GET</dt>
	<dd>Simply put, a GET request, well, <em>gets</em> data from a server. In most gasts, a GET request should only retrieve data and have no other effect.</dd>
	...
	<dt>PUT</dt>
	<dd>If the URI refers to an already existing resource, a PUT request takes its data and tries to replace (or put) that data in for that specific resource. This is most often used for updating existing pieces of data on the server or in the database.</dd>
