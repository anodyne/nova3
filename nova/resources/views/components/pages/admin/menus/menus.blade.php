					...
					<div class="row">
						...
						@can('manageMenuItems', $menu)
							<div class="col-xs-12 col-sm-6">
								<p><a href="{{ route('admin.menus.items', [$menu->id]) }}" class="btn btn-default btn-lg btn-block">{!! icon('list') !!}<span>Menu Items</span></a></p>
							</div>
						@endcan

						@can('manageMenuPages', $menu)
							<div class="col-xs-12 col-sm-6">
								<p><a href="{{ route('admin.menus.pages', [$menu->key]) }}" class="btn btn-default btn-lg btn-block">{!! icon('file') !!}<span>Pages Using this Menu</span></a></p>
							</div>
						@endcan
