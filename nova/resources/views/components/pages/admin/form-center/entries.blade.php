	...
	@foreach ($entries as $entry)
		<div class="row">
			...
			<div class="col-md-3" v-cloak>
				<mobile>
					<p><a href="{{ route('admin.form-center.show', [$form->key, $entry->id]) }}" class="btn btn-default btn-lg btn-block">View</a></p>

					@can('editEntries', $form)
						<p><a href="{{ route('admin.form-center.edit', [$form->key, $entry->id]) }}" class="btn btn-default btn-lg btn-block">Edit</a></p>
					@endcan
				...
				<desktop>
					<div class="btn-toolbar pull-right">
						<div class="btn-group">
							<a href="{{ route('admin.form-center.show', [$form->key, $entry->id]) }}" class="btn btn-default">View</a>

							@can('editEntries', $form)
								<a href="{{ route('admin.form-center.edit', [$form->key, $entry->id]) }}" class="btn btn-default">Edit</a>
							@endcan
						</div>
