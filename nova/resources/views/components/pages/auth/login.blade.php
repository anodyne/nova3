<div class="card">
	...
	<div class="card-footer">
		<div class="row">
			<div class="col-md-6">
				<a href="{{ route('password.email.show') }}" class="btn btn-link btn-block">{{ _m('auth-forgot-password') }}</a>
			</div>
			<div class="col-md-6">
				<a href="{{ route('home') }}" class="btn btn-link btn-block">{{ _m('auth-back-home') }}</a>
			</div>
		</div>
	</div>
</div>