<div class="text-center text-4xl font-extrabold mb-12 text-primary-dark">Reset Password</div>
...
<form role="form" method="POST" action="{{ route('password.request') }}">
	...
	<div class="mb-6">
		<label class="block mb-2 text-grey-darker uppercase tracking-wide text-sm font-medium">New Password</label>
	...
	<div class="mb-6">
		<label class="block mb-2 text-grey-darker uppercase tracking-wide text-sm font-medium">Confirm New Password</label>
