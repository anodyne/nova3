...
@php
    $styles = Illuminate\Support\Arr::toCssClasses([
        'sm:rounded-lg',
        'bg-white dark:bg-gray-900 shadow dark:shadow-md dark:ring-inset ring-1 ring-gray-950/5 dark:ring-white/[.03]' => $as === 'panel',
        'bg-white dark:bg-gray-900 ring-1 ring-gray-950/5 dark:ring-gray-800' => $as === 'no-shadow',
