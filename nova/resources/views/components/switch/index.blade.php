    ...
    <button
        ...
        @class([
            ...
            match ($color) {
                ...
                'panda' => '[--switch-bg-ring:theme(colors.gray.950/90%)] [--switch-bg:theme(colors.gray.900)] [--switch-ring:theme(colors.gray.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-bg-ring:theme(colors.gray.700/90%)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white/25%)] dark:[--switch-ring:theme(colors.gray.700/90%)]',
                default => '[--switch-bg-ring:theme(colors.primary.600/80%)] [--switch-bg:theme(colors.primary.500)] [--switch-ring:theme(colors.primary.600/80%)] [--switch-shadow:theme(colors.primary.900/20%)] [--switch:white] dark:[--switch-bg-ring:transparent]',
            },
        ])
        {{ $attributes->only('id') }}
    >
