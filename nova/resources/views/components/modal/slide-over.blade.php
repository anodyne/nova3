...
@php
    $badgeColor ??= $attributes->pluck('badge:color');
    $color ??= 'gray';
@endphp

<x-livewire-modal::stack class="backdrop-blur-xs">
    <x-livewire-modal::slideover class="{{ $sizeClass }} w-full overflow-auto shadow-xl">
                        ...
                        <div class="flex justify-between gap-6">
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @if ($badge)
                                        <x-badge :color="$badgeColor ?? 'gray'" size="md">{{ $badge }}</x-badge>
                                    @endif
                                </div>
                            </div>
