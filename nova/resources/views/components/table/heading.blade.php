...
<th
    {{ $attributes->merge(['class' => 'px-6 py-3 bg-gray-2'])->only('class') }}
>
    @unless ($sortable)
        <span class="flex text-left text-xs leading-4 font-semibold text-gray-9 uppercase tracking-wider">{{ $slot }}</span>
    @else
