...
const colors = {
    ...
    'grey-800': 'var(--color-grey-800, hsl(211, 39%, 23%))',
    'grey-700': 'var(--color-grey-700, hsl(209, 34%, 30%))',
    'grey-600': 'var(--color-grey-600, hsl(209, 28%, 39%))',
    'grey-500': 'var(--color-grey-500, hsl(210, 22%, 49%))',
    'grey-400': 'var(--color-grey-400, hsl(209, 23%, 60%))',
    'grey-300': 'var(--color-grey-300, hsl(211, 27%, 70%))',
    'grey-200': 'var(--color-grey-200, hsl(210, 31%, 80%))',
    'grey-100': 'var(--color-grey-100, hsl(212, 33%, 89%))',
    'grey-50': 'var(--color-grey-50, hsl(210, 36%, 96%))',
    ...
    'yellow-900': 'var(--color-yellow-900, hsl(15, 86%, 30%))',
    'yellow-800': 'var(--color-yellow-800, hsl(22, 82%, 39%))',
    'yellow-700': 'var(--color-yellow-700, hsl(29, 80%, 44%))',
    'yellow-600': 'var(--color-yellow-600, hsl(36, 77%, 49%))',
    'yellow-500': 'var(--color-yellow-500, hsl(42, 87%, 55%))',
    'yellow-400': 'var(--color-yellow-400, hsl(44, 92%, 63%))',
    'yellow-300': 'var(--color-yellow-300, hsl(48, 94%, 68%))',
    'yellow-200': 'var(--color-yellow-200, hsl(48, 95%, 76%))',
    'yellow-100': 'var(--color-yellow-100, hsl(48, 100%, 88%))',
    'yellow-50': 'var(--color-yellow-50, hsl(49, 100%, 96%))',
    ...
    'primary-darkest': 'var(--color-primary-darkest, #0f2f21)',
    'primary-darker': 'var(--color-primary-darker, #1a4731)',
    'primary-dark': 'var(--color-primary-dark, #1f9d55)',
    primary: 'var(--color-primary, #38c172)',
    'primary-light': 'var(--color-primary-light, #51d88a)',
    'primary-lighter': 'var(--color-primary-lighter, #a2f5bf)',
    'primary-lightest': 'var(--color-primary-lightest, #e3fcec)',
