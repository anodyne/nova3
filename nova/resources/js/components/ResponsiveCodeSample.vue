<template>
    <div>
        <div class="flex items-end justify-center mb-2 bg-white">
            <span
                :class="activeScreen === 'none' ? 'text-grey-darkest' : 'text-grey-dark'"
                class="inline-block text-center cursor-pointer select-none mr-8"
                @click="activeScreen = 'none'"
            >
                <svg
            ...
            <span
                :class="activeScreen === 'sm' ? 'text-grey-darkest' : 'text-grey-dark'"
                class="inline-block text-center cursor-pointer select-none mr-8"
            ...
            <span
                :class="activeScreen === 'md' ? 'text-grey-darkest' : 'text-grey-dark'"
                class="inline-block text-center cursor-pointer select-none mr-8"
            ...
            <span
                :class="activeScreen === 'lg' ? 'text-grey-darkest' : 'text-grey-dark'"
                class="inline-block text-center cursor-pointer select-none mr-8"
            ...
            <span
                :class="activeScreen === 'xl' ? 'text-grey-darkest' : 'text-grey-dark'"
        ...
        <div class="rounded overflow-hidden border border-grey-light mb-8">
            <div class="p-4 bg-grey-lightest border-b border-grey-light">
                <div
                    class="whitespace-pre font-mono text-grey text-xs overflow-x-auto"
                    v-html="highlightedCode"
                />
            </div>
            <div class="bg-white p-4">
                <slot
                    v-if="activeScreen === 'none'"
                    name="none"
                />
                <slot
                    v-if="activeScreen === 'sm'"
                    name="sm"
                />
                <slot
                    v-if="activeScreen === 'md'"
                    name="md"
                />
                <slot
                    v-if="activeScreen === 'lg'"
                    name="lg"
                />
                <slot
                    v-if="activeScreen === 'xl'"
                    name="xl"
                />
            </div>
        </div>
