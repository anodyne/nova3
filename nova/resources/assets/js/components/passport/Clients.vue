    ...
    <div>
		<app-card>
			<template slot="card-header">
				...
				<a class="button is-primary" tabindex="-1" @click="showCreateClientForm">
					<icon name="add" class="btn-icon"></icon>
					<span>Create New Client</span>
				</a>
			</template>

			<template slot="card-content" v-show="clients.length == 0">
				<p class="font-medium mb-0">
					You have not created any OAuth clients.
				</p>
			</template>

			<template slot="card-block" v-show="clients.length > 0">
				<div class="data-table has-controls in-card is-rounded-bottom">
					...
					<div class="row" v-for="client in filteredClients" :key="client.id">
						<div class="col-2">{{ client.id }}</div>
		...
		<!-- Create Client Modal -->
        <div class="hidden modal fade" id="modal-create-client" tabindex="-1" role="dialog">
        ...
        <!-- Edit Client Modal -->
        <div class="hidden modal fade" id="modal-edit-client" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
