...
class PopulatePagesTable extends Migration
{
    public function up()
    {
        ...
        $pages = [
            ...
            ['uri' => 'writing-overview', 'key' => 'writing-overview', 'resource' => 'Nova\\Stories\\Controllers\\WritingOverviewController', 'layout' => 'admin'],
            ...
            ['uri' => 'settings/appearance', 'key' => 'settings.appearance.edit', 'resource' => 'Nova\\Settings\\Controllers\\AppearanceSettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/appearance', 'key' => 'settings.appearance.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\AppearanceSettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/characters', 'key' => 'settings.characters.edit', 'resource' => 'Nova\\Settings\\Controllers\\CharacterSettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/characters', 'key' => 'settings.characters.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\CharacterSettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/content-ratings', 'key' => 'settings.content-ratings.edit', 'resource' => 'Nova\\Settings\\Controllers\\ContentRatingSettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/content-ratings', 'key' => 'settings.content-ratings.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\ContentRatingSettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/email', 'key' => 'settings.email.edit', 'resource' => 'Nova\\Settings\\Controllers\\EmailSettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/email', 'key' => 'settings.email.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\EmailSettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/general', 'key' => 'settings.general.edit', 'resource' => 'Nova\\Settings\\Controllers\\GeneralSettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/general', 'key' => 'settings.general.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\GeneralSettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/posting-activity', 'key' => 'settings.posting-activity.edit', 'resource' => 'Nova\\Settings\\Controllers\\PostingActivitySettingsController@edit', 'layout' => 'admin'],
            ['uri' => 'settings/posting-activity', 'key' => 'settings.posting-activity.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Settings\\Controllers\\PostingActivitySettingsController@update', 'layout' => 'admin'],
            ['uri' => 'settings/notifications', 'key' => 'settings.notifications.edit', 'resource' => 'Nova\\Settings\\Controllers\\NotificationSettingsController@edit', 'layout' => 'admin'],
            ...
            ['uri' => 'post-types', 'key' => 'post-types.index', 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@index', 'layout' => 'admin'],
            ['uri' => 'post-types/{postType}/show', 'key' => 'post-types.show', 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@show', 'layout' => 'admin'],
            ['uri' => 'post-types/create', 'key' => 'post-types.create', 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@create', 'layout' => 'admin'],
            ['uri' => 'post-types', 'key' => 'post-types.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@store', 'layout' => 'admin'],
            ['uri' => 'post-types/{postType}/edit', 'key' => 'post-types.edit', 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@edit', 'layout' => 'admin'],
            ['uri' => 'post-types/{postType}', 'key' => 'post-types.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Stories\\Controllers\\PostTypeController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'posts', 'key' => 'posts.index', 'resource' => 'Nova\\Stories\\Controllers\\PostController@index', 'layout' => 'admin'],
            ['uri' => 'stories/{story}/posts/{post}/show', 'key' => 'posts.show', 'resource' => 'Nova\\Stories\\Controllers\\PostController@show', 'layout' => 'admin'],
            ['uri' => 'posts/create/{neighbor?}/{direction?}', 'key' => 'posts.create', 'resource' => 'Nova\\Stories\\Controllers\\PostController@create', 'layout' => 'admin'],
            ['uri' => 'posts/{post}/edit', 'key' => 'posts.edit', 'resource' => 'Nova\\Stories\\Controllers\\PostController@edit', 'layout' => 'admin'],
