...
class PopulatePagesTable extends Migration
{
    public function up()
    {
        ...
        $pages = [
            ...
            ['uri' => 'site-themes', 'key' => 'themes.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Themes\\Controllers\\CreateThemeController@store', 'layout' => 'admin'],
            ['uri' => 'site-themes/{theme}/edit', 'key' => 'themes.edit', 'resource' => 'Nova\\Themes\\Controllers\\UpdateThemeController@edit', 'layout' => 'admin'],
            ['uri' => 'site-themes/{theme}', 'key' => 'themes.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Themes\\Controllers\\UpdateThemeController@update', 'layout' => 'admin'],
            ['uri' => 'site-themes/delete', 'key' => 'themes.delete', 'verb' => PageVerb::post, 'resource' => 'Nova\\Themes\\Controllers\\DeleteThemeController@confirm', 'layout' => 'admin'],
            ['uri' => 'site-themes/{theme}', 'key' => 'themes.destroy', 'verb' => PageVerb::delete, 'resource' => 'Nova\\Themes\\Controllers\\DeleteThemeController@destroy', 'layout' => 'admin'],
            ['uri' => 'site-themes/install', 'key' => 'themes.install', 'verb' => PageVerb::post, 'resource' => 'Nova\\Themes\\Controllers\\InstallThemeController', 'layout' => 'admin'],
            ...
            ['uri' => 'notes', 'key' => 'notes.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Notes\\Controllers\\CreateNoteController@store', 'layout' => 'admin'],
            ['uri' => 'notes/{note}/edit', 'key' => 'notes.edit', 'resource' => 'Nova\\Notes\\Controllers\\UpdateNoteController@edit', 'layout' => 'admin'],
            ['uri' => 'notes/{note}', 'key' => 'notes.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Notes\\Controllers\\UpdateNoteController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/groups', 'key' => 'ranks.groups.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Ranks\\Controllers\\Groups\\CreateRankGroupController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/groups/{group}', 'key' => 'ranks.groups.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Ranks\\Controllers\\Groups\\UpdateRankGroupController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/names', 'key' => 'ranks.names.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Ranks\\Controllers\\Names\\CreateRankNameController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/names/{name}', 'key' => 'ranks.names.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Ranks\\Controllers\\Names\\UpdateRankNameController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/items', 'key' => 'ranks.items.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Ranks\\Controllers\\Items\\CreateRankItemController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'ranks/items/{item}', 'key' => 'ranks.items.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Ranks\\Controllers\\Items\\UpdateRankItemController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'departments', 'key' => 'departments.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Departments\\Controllers\\CreateDepartmentController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'departments/{department}', 'key' => 'departments.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Departments\\Controllers\\UpdateDepartmentController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'positions', 'key' => 'positions.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Departments\\Controllers\\CreatePositionController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'positions/{position}', 'key' => 'positions.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Departments\\Controllers\\UpdatePositionController@update', 'layout' => 'admin'],
            ['uri' => 'positions/delete', 'key' => 'positions.delete', 'verb' => PageVerb::post, 'resource' => 'Nova\\Departments\\Controllers\\DeletePositionController@confirm', 'layout' => 'admin'],
            ['uri' => 'positions/{position}', 'key' => 'positions.destroy', 'verb' => PageVerb::delete, 'resource' => 'Nova\\Departments\\Controllers\\DeletePositionController@destroy', 'layout' => 'admin'],
            ['uri' => 'positions/confirm-duplicate', 'key' => 'positions.confirm-duplicate', 'verb' => PageVerb::post,  'resource' => 'Nova\\Departments\\Controllers\\DuplicatePositionController@confirm', 'layout' => 'admin'],
            ['uri' => 'positions/{original}/duplicate', 'key' => 'positions.duplicate', 'verb' => PageVerb::post, 'resource' => 'Nova\\Departments\\Controllers\\DuplicatePositionController@duplicate', 'layout' => 'admin'],
            ...
            ['uri' => 'characters', 'key' => 'characters.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Characters\\Controllers\\CreateCharacterController@store', 'layout' => 'admin'],
            ...
            ['uri' => 'characters/{character}', 'key' => 'characters.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Characters\\Controllers\\UpdateCharacterController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'stories', 'key' => 'stories.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Stories\\Controllers\\CreateStoryController@store', 'layout' => 'admin'],
            ['uri' => 'stories/{story}/edit', 'key' => 'stories.edit', 'resource' => 'Nova\\Stories\\Controllers\\UpdateStoryController@edit', 'layout' => 'admin'],
            ['uri' => 'stories/{story}', 'key' => 'stories.update', 'verb' => PageVerb::put, 'resource' => 'Nova\\Stories\\Controllers\\UpdateStoryController@update', 'layout' => 'admin'],
            ...
            ['uri' => 'stories', 'key' => 'stories.destroy', 'verb' => PageVerb::delete, 'resource' => 'Nova\\Stories\\Controllers\\DeleteStoryController@destroy', 'layout' => 'admin'],
            ...
            ['uri' => 'stories/reorder', 'key' => 'stories.reorder.update', 'verb' => PageVerb::post, 'resource' => 'Nova\\Stories\\Controllers\\ReorderStoriesController@reorder', 'layout' => 'admin'],
            ...
            // ['uri' => 'posts', 'key' => 'posts.store', 'verb' => PageVerb::post, 'resource' => 'Nova\\Posts\\Controllers\\CreatePostController@store', 'layout' => 'admin'],
