...
class PopulatePagesTable extends Migration
{
    ...
    protected function populateAdminPages(): void
    {
        $pages = [
            ...
            ['name' => 'Writing dashboard', 'uri' => 'admin/writing-overview', 'key' => 'admin.writing-overview', 'resource' => 'Nova\\Stories\\Controllers\\WritingOverviewController', 'layout' => 'admin', 'heading' => 'My draft posts', 'subheading' => 'Drafts are posts in progress that have not been published'],
