...
return new class extends OneTimeOperation
{
    ...
    protected function populateAdminPages(): void
    {
        $pages = [
            ...
            ['name' => 'Environment settings', 'uri' => 'admin/settings/environment', 'key' => 'admin.settings.environment.edit', 'resource' => 'Nova\\Settings\\Controllers\\EnvironmentSettingsController@edit', 'layout' => 'admin', 'heading' => 'Environment settings'],
            ...
            ['name' => 'Writing dashboard settings', 'uri' => 'admin/settings/writing-dashboard', 'key' => 'admin.settings.writing-dashboard.edit', 'resource' => 'Nova\\Settings\\Controllers\\WritingDashboardSettingsController@edit', 'layout' => 'admin', 'heading' => 'Writing dashboard settings'],
        ...
        Page::unguarded(fn () => collect($pages)->each(
            fn (array $data) => $this->createPage($data)
        ));
    }
    ...
    protected function populatePublicPages(): void
    {
        ...
        Page::unguarded(fn () => collect($advancedPages)->each(
            fn (array $data) => $this->createPage($data)
        ));
    }
    ...
    protected function createPage(array $data): void
    {
        ...
        if (in_array(data_get($data, 'verb'), [PageVerb::Delete, PageVerb::Post, PageVerb::Put])) {
