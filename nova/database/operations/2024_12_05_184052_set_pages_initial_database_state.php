...
return new class extends OneTimeOperation
{
    ...
    protected function populateAdminPages(): void
    {
        $pages = [
            ...
            ['name' => 'Update dashboard settings', 'uri' => 'admin/settings/dashboard', 'key' => 'admin.settings.dashboard.update', 'verb' => PageVerb::Put, 'resource' => 'Nova\\Settings\\Controllers\\DashboardSettingsController@update', 'layout' => 'admin'],
