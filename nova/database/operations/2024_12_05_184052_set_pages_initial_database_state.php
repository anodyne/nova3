...
return new class extends OneTimeOperation
{
    ...
    protected function populateAdminPages(): void
    {
        $pages = [
            ...
            ['name' => 'Error logs', 'uri' => 'admin/error-logs', 'key' => 'admin.error-logs.index', 'resource' => 'Nova\\Dashboards\\Controllers\\ErrorLogController', 'layout' => 'admin', 'content_can_be_edited' => true, 'heading' => 'Error logs'],
            ...
            ['name' => 'List add-ons', 'uri' => 'admin/addons', 'key' => 'admin.addons.index', 'resource' => 'Nova\\Addons\\Controllers\\AddonController@index', 'layout' => 'admin', 'content_can_be_edited' => true, 'heading' => 'Add-ons', 'subheading' => 'Personalize and extend Nova with add-ons'],
            ['name' => 'Show add-on', 'uri' => 'admin/addons/{addon}/show', 'key' => 'admin.addons.show', 'resource' => 'Nova\\Addons\\Controllers\\AddonController@show', 'layout' => 'admin', 'content_can_be_edited' => true, 'heading' => 'View add-on'],
            ['name' => 'Create add-on', 'uri' => 'admin/addons/create', 'key' => 'admin.addons.create', 'resource' => 'Nova\\Addons\\Controllers\\AddonController@create', 'layout' => 'admin', 'content_can_be_edited' => true, 'heading' => 'Add a new add-on'],
